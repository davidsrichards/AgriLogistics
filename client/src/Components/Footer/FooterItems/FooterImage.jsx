        ...
        <div className="flex flex-col  justify-center gap-4 text-white">
            <div className="flex items-start  gap-6 transition-all duration-300 ease-in-out ">
                ...
                <div className="text-white -space-y-1  text-nowrap transition-all duration-300 ease-in-out footer-item ">
                    ...
                    <h3 className="font-normal text-[#328d4a]">
                        Logistics Limited
                    </h3>
                </div>
            </div>
            <p className="footer-h">
                Why in the world would you choose our agriculture out of all
                other Milwaukee locations?
            </p>
            {/*  */}
            <p className="footer">
                We believe that our diverse choice of green, rose and white
                grains, on par with a huge range of miscellaneous countries of
                those grains' origins can be a winning factor. All this makes us
                the ultimate place where you are able to order paired grain with
